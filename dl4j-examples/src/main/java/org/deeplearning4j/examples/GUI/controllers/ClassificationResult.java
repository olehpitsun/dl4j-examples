...
public class ClassificationResult extends Application {
    ...
    public void start(Stage stage) {
        ...
        String labels[]={"eee", "кістозна мастопатія","мастопатія","фібро мастопатія","eee","eeewww","www"};
        System.out.println(labels[0]);


        System.out.println("33333333333333333333333333333333333333333333" + StringExample.getHashMap().entrySet());
        Set<Map.Entry<String, String>> set = StringExample.getHashMap().entrySet();

        ObservableList<PieChart.Data> pieChartData = FXCollections.observableArrayList();

        for (Map.Entry<String, String> me : set) {
            System.out.println("get key " + Integer.parseInt(me.getKey().trim()) + " value " + Double.parseDouble(me.getValue()));
