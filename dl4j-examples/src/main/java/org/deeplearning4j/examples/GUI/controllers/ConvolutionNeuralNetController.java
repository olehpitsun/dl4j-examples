...
import org.deeplearning4j.examples.convolution.CnnClassification;
        ...
        if(isInputValid()){
            ...
            Task<Void> task = new Task<Void>() {
                ...
                public Void call() throws Exception {
                    ...
                    CnnParams.setPatjToFolder(pathToFolder);
                    CnnParams.setEpochs(Integer.valueOf(epocheNumb));
                    CnnParams.setIterations(Integer.valueOf(iterCount));
                    CnnParams.setHeight(130);
                    CnnParams.setWidth(130);

                    try {
                        new AnimalsClassification().run();

                        //AnimalsClassification classification = new AnimalsClassification();
    ...
    private void startClassification(){
        ...
        Task<Void> task = new Task<Void>() {
            ...
            public Void call() throws Exception {
                ...
                CnnParams.setPatjToFolder(pathToFolder);
                CnnParams.setBatches(Integer.parseInt(batchClassificationSixe));
                CnnParams.setClasses(classCount);

                try {

                    CnnClassification cnnClassification = new CnnClassification();
                    String classificationResult = cnnClassification.run();
