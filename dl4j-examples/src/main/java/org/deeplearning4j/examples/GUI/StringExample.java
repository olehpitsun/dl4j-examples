...
*/
        String prefix = "Examples labeled as 1 classified by model as";
        ...
        for (int i = 0; i < tokens.length; i++) {
            choosedStr[i] = compareStr(tokens[i], "Examples labeled as 1 classified by model");
        }
        ...
        for (int i = 0; i < choosedStr.length; i++) {
            ...
            if (choosedStr[i] != null && choosedStr[i] != "") {
                ...
                System.out.println(getSubStr(strTemp, 50, 52) + " - second result");

                String findClass = getSubStr(strTemp, 46, 48) ;

                String count = getSubStr(strTemp, 50, 52) ;
